...
use App\Filament\Resources\KeterlambatanResource\Api\Requests\UpdateKeterlambatanRequest;
...
class UpdateHandler extends Handlers {
     ...
     *
     * @param UpdateKeterlambatanRequest $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function handler(UpdateKeterlambatanRequest $request)
    {
        $id = $request->route('id');
